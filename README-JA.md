...
- **[SAAI Knowledge for WooCommerce](plugins/saai-knowledge-for-woocommerce/)** — 有料版アドオン。FAQ/KB/用語集コンテンツを WooCommerce の商品・商品カテゴリーに紐づけます。ソースコードはこのモノレポ内で開発中ですが、WooCommerce.com Marketplace での販売用リスティングはまだ公開されていません。無料版単体でも利用可能で、有料版は必須ではありません。
